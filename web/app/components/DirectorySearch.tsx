    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-ink-900/50 border border-ink-800 rounded-lg text-sm font-mono text-ink-100 placeholder-ink-500 focus:border-ember-500/50 transition-colors"
        />
        {searchQuery && (
          <button
