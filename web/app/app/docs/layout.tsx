...
export default function DocsLayout({
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden text-ink-400 hover:text-ink-200 p-1"
            >
          ...
          <nav className="flex items-center gap-3 sm:gap-6 text-sm">
            ...
            <Link href="/directory" className="text-ink-400 hover:text-ink-200 transition-colors hidden sm:block">
              Directory
            </Link>
      ...
      {/* Mobile nav dropdown */}
      {mobileNavOpen && (
        <div className="lg:hidden border-b border-ink-800 bg-ink-950/95 backdrop-blur-sm">
      ...
      <div className="max-w-6xl mx-auto flex">
        ...
        <aside className="hidden lg:block w-64 flex-shrink-0 border-r border-ink-800 min-h-[calc(100vh-65px)] sticky top-[65px] self-start">
              ...
              return (
                <Link
                  ...
                  className={`
                    block px-3 py-2 rounded-lg text-sm transition-colors
                    ${isActive 
                      ? 'bg-ember-600/10 text-ember-300 font-medium' 
                      : 'text-ink-400 hover:text-ink-200 hover:bg-ink-800/50'
                    }
                  `}
                >
